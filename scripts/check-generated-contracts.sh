...
if [[ -n "$(git status --porcelain --untracked-files=all -- packages/review-types/generated/json-schema)" ]]; then
  echo "[contracts] ERROR: generated JSON Schema artifacts are stale" >&2
  git status --short --untracked-files=all -- packages/review-types/generated/json-schema >&2
