...
- [Final Launch Signoff - 2026-05](./release/final-launch-signoff-2026-05.md)
...
- Git diff corpus and Rust helper: `packages/review-git/test/fixtures/diff-corpus/expected.json`
